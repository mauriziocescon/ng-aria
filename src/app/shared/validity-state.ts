...
export class ValidityState implements OnInit {
  ...
  ngOnInit() {
    this.renderer.setAttribute(this.el.nativeElement, 'role', 'img');
    this.renderer.setStyle(this.el.nativeElement, 'display', 'inline-flex');
    this.renderer.setStyle(this.el.nativeElement, 'line-height', '1');
    this.renderer.setStyle(this.el.nativeElement, 'vertical-align', '-0.125em');
  }
